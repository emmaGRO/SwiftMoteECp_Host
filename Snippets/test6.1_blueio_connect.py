...
target_device_address = '[1]C3:D8:3C:EB:54:65'

# Requests connection with target
r=my_dongle.at_gapconnect(addr=target_device_address, timeout = 10, intv_min = "", intv_max = "", slave_latency = "", sup_timeout = "")
